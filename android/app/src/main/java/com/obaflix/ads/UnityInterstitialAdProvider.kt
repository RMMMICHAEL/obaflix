 ...
 * quando exibir vive no servidor (src/lib/ads), e nao aqui — este arquivo nao
...
class UnityInterstitialAdProvider(
        ...
        runCatching {
            UnityAds.initialize(app, gameId, testMode, object : IUnityAdsInitializationListener {
                override fun onInitializationComplete() {
                    inicializando = false
                    inicializado = true
                    ObaLog.evento(FASE, "unity_init_ok")
    ...
    override fun show(host: AdHost, aoAbrir: () -> Unit, aoTerminar: (AdShowOutcome) -> Unit) {
        ...
        fun terminar(resultado: AdShowOutcome, motivo: String) {
            ...
            ObaLog.evento(FASE, "unity_show_end", "motivo" to motivo)
        ...
        runCatching {
            UnityAds.show(activity, placementId, object : IUnityAdsShowListener {
                ...
                override fun onUnityAdsShowComplete(
                    ...
                    ObaLog.evento(FASE, "unity_show_complete")
    ...
    private companion object {
        /** Fase de log desta camada. Antes vinha de `PlaybackAdGate`. */
        const val FASE = "ADS"
