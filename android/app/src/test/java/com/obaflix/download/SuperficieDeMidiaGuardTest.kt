 ...
 *
 * O pacote de anuncios (`com.obaflix.ads`) existe no aplicativo, e quem decide
 * se ha anuncio e o servidor — a ponte nativa so exibe quando mandam. Download e
 * transmissao nao podem nem conhecer esse pacote: se alguem os ligar a contagem
 * de reproducao, baixar uma temporada inteira contaria como doze intencoes de
 * assistir, e a frequencia de anuncio mudaria sem ninguem perceber.
 */
